            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <label htmlFor="duration" className="block text-sm font-medium text-gray-700">
                  Duration (calculée automatiquement)
                </label>
                <input
                  type="number"
                  id="duration"
                  ...
                  placeholder="Sera calculée selon les questions ajoutées"
                />
                <p className="mt-1 text-xs text-gray-500">
                  La durée sera automatiquement calculée en fonction des questions ajoutées
                </p>
              </div>
